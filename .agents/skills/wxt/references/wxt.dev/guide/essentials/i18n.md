---
title: "I18n – WXT"
source_url: "https://wxt.dev/guide/essentials/i18n"
fetched_at: "2026-03-06T07:09:09.689083+00:00"
---



Are you an LLM? You can read better optimized documentation at /guide/essentials/i18n.md for this page in Markdown format

# I18n [​](https://wxt.dev/guide/essentials/i18n.html#i18n)
...
* [Usage](https://wxt.dev/guide/essentials/i18n.html#usage)
* [Alternatives](https://wxt.dev/guide/essentials/i18n.html#alternatives)
...
However, it is recommended you stick with the vanilla API (or a package based on top of the vanilla API, like [`@wxt-dev/i18n`](https://wxt.dev/i18n.html)), because:
