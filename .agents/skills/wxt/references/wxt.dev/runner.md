---
title: "@wxt-dev/runner – WXT"
source_url: "https://wxt.dev/runner"
...
## Usage [​](https://wxt.dev/runner.html#usage)

### With WXT [​](https://wxt.dev/runner.html#with-wxt)
...
### JS API [​](https://wxt.dev/runner.html#js-api)
...
### Target [​](https://wxt.dev/runner.html#target)
...
### Data Persistence [​](https://wxt.dev/runner.html#data-persistence)

Browsers block you from using your normal browser profiles when using the [BiDi and CDP protocols](https://wxt.dev/runner.html#implementation-details) for security reasons.
...
If you want to customize your data persistence beyond what these presets define, [you can override the browser flags yourself](https://wxt.dev/runner.html#arguments) to configure persistence.

### Browser Binaries [​](https://wxt.dev/runner.html#browser-binaries)
...
### Arguments [​](https://wxt.dev/runner.html#arguments)
...
### Start URLs [​](https://wxt.dev/runner.html#start-urls)
...
### Debugging [​](https://wxt.dev/runner.html#debugging)
...
## Implementation Details [​](https://wxt.dev/runner.html#implementation-details)
...
### Firefox [​](https://wxt.dev/runner.html#firefox)
...
### Chrome [​](https://wxt.dev/runner.html#chrome)
