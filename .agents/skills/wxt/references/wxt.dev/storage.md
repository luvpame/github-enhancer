---
title: "WXT Storage – WXT"
source_url: "https://wxt.dev/storage"
...
For a full list of methods available, see the [API reference](https://wxt.dev/api/reference/wxt/utils/storage/interfaces/wxtstorage.html).
...
For a full list of properties and methods available, see the [API reference](https://wxt.dev/api/reference/wxt/utils/storage/interfaces/wxtstorageitem.html).
...
Refer to the [API Reference](https://wxt.dev/api/reference/wxt/utils/storage/interfaces/wxtstorage.html) for types and examples of how to use all the bulk APIs.
