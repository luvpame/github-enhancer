---
title: "@wxt-dev/i18n – WXT"
source_url: "https://wxt.dev/i18n"
fetched_at: "2026-03-06T07:09:09.689083+00:00"
---



Are you an LLM? You can read better optimized documentation at /i18n.md for this page in Markdown format

# `@wxt-dev/i18n` [​](https://wxt.dev/i18n.html#wxt-dev-i18n)
...
3. Integrates with the [I18n Ally VS Code extension](https://wxt.dev/i18n.html#vs-code)
...
You don't have to use `wxt` to use this package - it will work in any bundler setup. See [Installation without WXT](https://wxt.dev/i18n.html#without-wxt) for more details.

## Installation [​](https://wxt.dev/i18n.html#installation)

### With WXT [​](https://wxt.dev/i18n.html#with-wxt)
...
### Without WXT [​](https://wxt.dev/i18n.html#without-wxt)
...
2. Create a messages file at `_locales/<lang>/messages.json` or move your existing translations there:
   ...
   See [Build Integrations](https://wxt.dev/i18n.html#build-integrations) to set it up.
...
## Configuration [​](https://wxt.dev/i18n.html#configuration)
...
## Messages File Format [​](https://wxt.dev/i18n.html#messages-file-format)

DANGER

You can only use the file format discussed on this page if you have [integrated `@wxt-dev/i18n` into your build process](https://wxt.dev/i18n.html#build-integrations). If you have not integrated it into your build process, you must use JSON files in the `_locales` directory, like a normal web extension.

### File Extensions [​](https://wxt.dev/i18n.html#file-extensions)
...
### Nested Keys [​](https://wxt.dev/i18n.html#nested-keys)
...
### Substitutions [​](https://wxt.dev/i18n.html#substitutions)
...
#### Escapting `$` [​](https://wxt.dev/i18n.html#escapting)
...
### Plural Forms [​](https://wxt.dev/i18n.html#plural-forms)
...
### Verbose Keys [​](https://wxt.dev/i18n.html#verbose-keys)
...
## Build Integrations [​](https://wxt.dev/i18n.html#build-integrations)
...
### WXT [​](https://wxt.dev/i18n.html#wxt)

See [Installation with WXT](https://wxt.dev/i18n.html#with-wxt).
...
### Custom [​](https://wxt.dev/i18n.html#custom)
...
#### Type Safety [​](https://wxt.dev/i18n.html#type-safety)

Once you've generated `wxt-i18n-structure.d.ts` (see the [Custom](https://wxt.dev/i18n.html#custom) section), you can use it to pass the generated type into `createI18n`:
...
## Editor Support [​](https://wxt.dev/i18n.html#editor-support)

For better DX, you can configure your editor with plugins and extensions.

### VS Code [​](https://wxt.dev/i18n.html#vs-code)
...
### Zed [​](https://wxt.dev/i18n.html#zed)

As of time of writing, Aug 18, 2024, no extensions exist for Zed to add I18n support.

### Jetbrains IDEs [​](https://wxt.dev/i18n.html#jetbrains-ides)

Install the [I18n Ally plugin](https://plugins.jetbrains.com/plugin/17212-i18n-ally). The docs are limited around their Jetbrains support, but you'll probably need to configure the plugin similar to [VS Code](https://wxt.dev/i18n.html#vs-code)... Not sure where the files go though.
