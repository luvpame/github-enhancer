---
title: "wxt submit – WXT"
source_url: "https://wxt.dev/api/cli/wxt-submit"
fetched_at: "2026-03-06T07:09:09.689083+00:00"
---



Are you an LLM? You can read better optimized documentation at /api/cli/wxt-submit.md for this page in Markdown format

# `wxt submit` [​](https://wxt.dev/api/cli/wxt-submit.html#wxt-submit)
...
Commands:
        Submit an extension to multiple stores for review
  init  Interactive walkthrough to initialize or update secrets and options for each store

For more info, run any command with the `--help` flag:
  $ wxt submit --help
  $ wxt submit init --help
